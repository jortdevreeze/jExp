...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
    ...
    <form action="<?php echo $this->link('edit', array('id' => $this->experiment['id'])); ?>" method="post" class="jExp-form">
        <h1>Experiment Form 
            <span>Please fill all the texts in the fields.</span>
        </h1>
        <label>
            <span>Experiment Name :</span>
            <input id="name" type="text" name="name" value="<?php echo $this->experiment['name']; ?>" />
        </label>
